...
//*********************常规参数变量***********************
    ...
    QString SpellUpStr(stuSJCYZBMB stu,int type,double dMax,double dMin,double dAvg,double dTotal); //type 判断分钟还是小时还是日
    ...
    QString SpellUpDataTable(char *QQBM,char *MLBM,int nFlag);    //拼接数据段结构组成表
